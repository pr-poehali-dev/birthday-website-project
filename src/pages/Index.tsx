...
const DATES = [
  ...
  { year: '2026', title: 'Этот праздник', icon: 'PartyPopper', text: 'Новый юбилей и куча поздравлений!', photo: 'https://cdn.poehali.dev/projects/1cfaa32b-9a4d-4020-8de4-4ee2ef6b9f37/bucket/4c98b3e8-f48b-4e41-a831-0cc493a942e9.jpg', photoFit: 'contain' },
];
              ...
              {d.photo ? (
                <div className="relative mx-auto w-full overflow-hidden rounded-2xl border-4 border-white shadow-md" style={{ aspectRatio: '4/3' }}>
                  <img
                    src={d.photo}
                    alt={d.title}
                    className={`h-full w-full transition-transform duration-500 group-hover:scale-105 ${d.photoFit === 'contain' ? 'object-contain' : 'object-cover'}`}
